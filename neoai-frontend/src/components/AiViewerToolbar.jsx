...
export function AiViewerToolbar({
  isHoldMode,
  isZoomMode,
  isMagnifierMode,
  isViewChanged,
    ...
    <div className="selection-viewer-header ai-module-viewer-header">
      <div className="viewer-header-actions">
        <div className="viewer-header-side viewer-header-side-left">
          <SelectionToolbar ariaLabel="AI viewer tools">
            <button
            ...
            <button className="selection-toolbar-icon-button" type="button" onClick={handleRotateLeft} title="Rotate view 90 degree left">
              <RotateLeftRoundedIcon fontSize="small" />
            </button>
            <button className="selection-toolbar-icon-button" type="button" onClick={handleRotateRight} title="Rotate view 90 degree right">
        ...
        <div className="viewer-header-center">{centerContent}</div>
        <div className="viewer-header-side viewer-header-side-right">
          <div className="viewer-primary-actions">{rightContent}</div>
        </div>
      </div>
    </div>
  );
